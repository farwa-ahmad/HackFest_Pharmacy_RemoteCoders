  ...
  <footer class="page-footer">
    ...
    <div class="footer-nav">
      <div class="container clearfix">
        ...
        <div class="footer-nav__col footer-nav__col--info">
          <div class="footer-nav__heading">ABOUT</div>
          <ul class="footer-nav__list">
            <li class="footer-nav__item">
              <a href="#" class="footer-nav__link">Our Story</a>
            </li>
            <li class="footer-nav__item">
              <a href="#" class="footer-nav__link">How LifeLine Works</a>
            </li>
            <li class="footer-nav__item">
        ...
        <div class="footer-nav__col footer-nav__col--whybuy">
          <div class="footer-nav__heading">Why us</div>
          <ul class="footer-nav__list">
            <li class="footer-nav__item">
        ...
        <div class="footer-nav__col footer-nav__col--account">
          <div class="footer-nav__heading">Account</div>
          <ul class="footer-nav__list">
            <li class="footer-nav__item">
            ...
            <li class="footer-nav__item">
              <a href="#" class="footer-nav__link">Medical Reports</a>
            </li>
          </ul>
        </div>
    ...
    <div class="page-footer__subline">
      <div class="container clearfix">
        ...
        <div class="copyright">
          &copy; <?php echo date("Y"); ?> LifeLine&trade;
        </div>
