			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					<!-- <li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Order and Delivery Support</a>
					</li> -->
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Technical Support</a>
					</li>
					<li class="footer-nav__item">
...
Remote, World.
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2022 HackFest&trade;
			</div>

			<div class="developer">
				Designed &amp; Developed by Remote Coders
			</div>

			<!-- <div class="designby">
				Design by Remote Coders
			</div> -->
		</div>
	</div>
</footer>
